  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-300">
        Search, compare, and book flights in seconds. Airflow brings the entire
        travel experience into one seamless platform with real-time schedules,
        smart pricing, and effortless booking management.
      </p>
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      <a
        href={product.link}
        className="block group-hover/product:shadow-2xl group-hover/product:shadow-blue-500/10"
      >
        <img
