    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          ...
          >
            <IconArrowNarrowLeft className="h-6 w-6 text-neutral-400" />
          </button>
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800 disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <IconArrowNarrowRight className="h-6 w-6 text-neutral-400" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            <motion.div
              ...
              className="relative z-[60] mx-auto my-10 h-fit max-w-5xl rounded-3xl bg-neutral-950 border border-neutral-800 p-4 font-sans md:p-10"
            >
              <button
                className="sticky top-4 right-0 ml-auto flex h-8 w-8 items-center justify-center rounded-full bg-neutral-800"
                onClick={handleClose}
              >
